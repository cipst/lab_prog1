...
public class Media {
    ...
    public static void main(String[] args) {
        ...
        //***(int)media3 --> tronca il valore double --> tutto ciò che c'è dopo la virgola viene eliminato
        //***(int)Math.round(media3) --> arrotonda media3 per eccesso o difetto --> poi viene fatto il cast a int
        
        System.out.println("");
        // Problemi imprevisti dovuti a range di numeri finito,
        // che portano a rappresentazione binaria approssimata
        double f = 4.35;
        System.out.println((int)Math.round((f * 100))); // provare Math.round prima del cast!
